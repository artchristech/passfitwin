  ...
  return (
    <div className="p-4 space-y-6">
      ...
      <div className="text-center">
        <h2 className="text-2xl font-bold text-gray-800 mb-2">Fitness Challenges</h2>
        <p className="text-gray-600">Push your limits and earn rewards!</p>
      </div>
      ...
      <div>
        <div className="flex items-center space-x-2 mb-4">
          ...
          <h3 className="text-lg font-semibold text-gray-800">Special Events</h3>
        </div>
        <div className="space-y-4">
