      ...
      <div className="flex items-center space-x-2 sm:space-x-3">
        <div className="flex-1 relative">
          <input
            ...
            disabled={isTyping}
            className="w-full px-4 py-2 bg-zinc-700 border border-zinc-600 text-zinc-100 placeholder-zinc-400 rounded-full focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-orange-400 disabled:opacity-50 transition-all duration-300 text-sm sm:px-6 sm:py-3 sm:text-base"
          />
        </div>
